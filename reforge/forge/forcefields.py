...
class Martini30RNA(NucleicForceField):
    ...
    def __init__(self, directory="rna_reg", mol=RNA_SYSTEM, version="new"):
        ...
        self.bb_bonds = [
            [(0, 1), (1, 0.350, 15000), ("BB1-BB2")],
            [(1, 2), (1, 0.239, 15000), ("BB2-BB3")],
            [(1, 0), (1, 0.378, 12000), ("BB2-BB1n")],
            [(2, 0), (1, 0.412, 12000), ("BB3-BB1n")],
        ]
        self.bb_angles = [
            [(0, 1, 0), (10, 112.0, 150), ("BB1-BB2-BB1n")],
            [(1, 0, 1), (10, 118.0, 180), ("BB2-BB1n-BB2n")],
            [(0, 1, 2), (10, 138.0, 500), ("BB1-BB2-BB3")],
        ]
        self.bb_dihs = [
            [(0, 1, 0, 1), (1, 0.0, 20.0, 1), ("BB1-BB2-BB1n-BB2n")],
            [(-2, 0, 1, 0), (1, 0.0, 20.0, 1), ("BB2p-BB1-BB2-BB1n")],
