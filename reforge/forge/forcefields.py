...
class Martini30RNA(NucleicForceField):
    ...
    def __init__(self, directory="rna_reg", mol=RNA_SYSTEM, version="new"):
        ...
        self.bb_dihs = [
            [( 0, 1, 0, 1), (9,  200.0,  8.0, 1), ("BB1-BB2-BB1n-BB2n")],  # 3/29/2025 3.18 good version
            [( 0, 1, 0, 1), (9,   40.0,  1.7, 2), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,   80.0,  1.0, 4), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,  100.0,  2.2, 5), ("BB1-BB2-BB1n-BB2n")],  
            [(-2, 0, 1, 0), (1,    0.0,  6.0, 1), ("BB2p-BB1-BB2-BB1n")],
            [(-2, 0, 1, 2), (1, -115.0, 10.0, 1), ("BB2p-BB1-BB2-BB3")],
        ]
        # self.bb_dihs = [
