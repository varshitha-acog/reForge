...
class Martini30RNA(NucleicForceField):
    ...
    def __init__(self, directory="rna_reg", mol=RNA_SYSTEM, version="new"):
        ...
        self.bb_angles = [
            ...
            [(1, 0, 1), (10, 120.0, 200), ("BB2-BB1n-BB2n")],
            [(0, 1, 2), (10, 139.0, 200), ("BB1-BB2-BB3")],
        ]
        self.bb_dihs = [
            [( 0, 1, 0, 1), (9,  180.0,  8.0, 1), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,    0.0,  1.7, 2), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,    0.0,  1.0, 4), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,    0.0,  2.5, 5), ("BB1-BB2-BB1n-BB2n")],  
            [(-2, 0, 1, 0), (1,    0.0,  8.0, 1), ("BB2p-BB1-BB2-BB1n")],
            [(-2, 0, 1, 2), (1, -100.0, 15.0, 1), ("BB2p-BB1-BB2-BB3")],
        ]
        # self.bb_dihs = [
