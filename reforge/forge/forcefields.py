...
class Martini30RNA(NucleicForceField):
    ...
    def __init__(self, directory="rna_reg", mol=RNA_SYSTEM, version="new"):
        ...
        self.bb_angles = [
            ...
            [(1, 0, 1), (10, 122.0, 150), ("BB2-BB1n-BB2n")],
            [(0, 1, 2), (10, 142.0, 300), ("BB1-BB2-BB3")],
        ]
        self.bb_dihs = [
            [( 0, 1, 0, 1), (9,  210.0,  8.0, 1), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,   60.0,  1.7, 2), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,  120.0,  1.0, 4), ("BB1-BB2-BB1n-BB2n")],  
            [( 0, 1, 0, 1), (9,  150.0,  2.5, 5), ("BB1-BB2-BB1n-BB2n")],  
            [(-2, 0, 1, 0), (1,    0.0, 15.0, 1), ("BB2p-BB1-BB2-BB1n")],
            [(-2, 0, 1, 2), (1, -115.0, 15.0, 1), ("BB2p-BB1-BB2-BB3")],
        ]
        # self.bb_dihs = [
        ...
        #     [(-2, 0, 1, 2), (1, -112.0, 10.0, 1), ("BB2p-BB1-BB2-BB3")],
        # ]
        self.bb_cons = []
